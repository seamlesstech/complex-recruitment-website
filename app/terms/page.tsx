...
{title:'Acceptable use',body:'Design-stage placeholder for lawful website use, security, misuse and information submitted by users.'},
{title:'Jobs and applications',body:'Placeholder clarifying that vacancy publication and application submission do not create an employment relationship or guarantee placement.'},
{title:'Intellectual property',body:'Placeholder for approved ownership and permitted-use wording covering website content, branding and materials.'},
{title:'Liability and governing law',body:'Placeholder for wording to be supplied or approved by Complex’s legal adviser before launch.'},
]}/>}
