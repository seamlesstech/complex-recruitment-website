...
{title:'Analytics and measurement',body:'Placeholder for the analytics tools actually selected for launch. Do not list services that are not implemented.'},
{title:'Marketing technologies',body:'Placeholder only. Remove this section if the production site does not use marketing or advertising cookies.'},
{title:'Managing preferences',body:'Placeholder for the final cookie-consent mechanism and browser-control information.'},
]}/>}
